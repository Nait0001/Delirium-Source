	...
	public function reloadNote()
	{
		...
		else
		{
			...
			switch (Math.abs(noteData) % 4)
			{
				case 0:
					// LEFT
					animation.addByPrefix('static',  'arrow static instância 4');
				...
				case 1:
					// DOWN
					animation.addByPrefix('static',  'arrow static instância 3');
